...
public class Change_password extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      ...
      String newpassword1 = jPasswordField2.getText();
      String newpassword2 = jPasswordField3.getText();
      
      if (newpassword1.equals(newpassword2)){
          try{
              ResultSet rs = new Model().data("select password from airport_login where username = '"+username+"'");
              if(rs.next()){
                  if (password.equals(rs.getString("password"))){
      new Model().dataup("update airport_login set Password='"+newpassword1+"' where Username='"+username+"' and password = '"+password+"'");    
