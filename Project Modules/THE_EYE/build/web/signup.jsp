...
<body>
     <div class="container">
         ...
         <form id="sign-form" class="sign-form" action="signupact.jsp?post=<%out.print(request.getParameter("post")); %>" method="POST">
                <ol class="questions">
			...
			<input class="active" id="name" name="name" type="text" placeholder="Enter your full name" autofocus/>
                   ...
                   <li>
                     ...
                     <li>
                        <span><label for="DOB">what is your Date of Birth?</label></span>
                        <input id="DOB" name="dob" type="Date" placeholder="Date of Birth" autofocus/>
                      </li>
                       <li>
                        <span><label for="age">Oh sorry.. Can you tell me your age too?</label></span>
                        <input id="age" name="age" type="text" placeholder="Enter your Age" autofocus/>
                      </li>
                        <li>
                           <span><label for="qual">Wait wait... What about your qualification?</label></span>
                           <input id="qual" name="qualification" type="text" placeholder="Enter your Qualification" autofocus/>
                        </li>
                    <li><p style="margin-top: 45px;font-size: 32pt;float:right">
                            <input type="submit" class="btn btn-success" value="Sign Up"></p>    </li>
