...
//encrypt and decrypt text using simple algo of offsetting
...
public static void main(String[] args) {
   String text = "ilovecheese but not when i am selfie";
   int offset = 5;
...
static String encrypt(String text , int offset)
{
    ...
    System.out.println(plain.length);//length of i love cheese
    System.out.println(chars.length);//length of chars array
